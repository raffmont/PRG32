...
## 2026 update: external controllers and Wi-Fi scores

URG32 now includes optional support for external standard USB game controllers through a USB-HID-host bridge and a Wi-Fi REST API for game/player/score records.
