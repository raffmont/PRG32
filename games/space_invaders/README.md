...
- `ascii/game.S`: uses the URG32 console API and runs in UART-only, LCD-only text, or mirrored mode.
- `graphics/game.S`: uses the 320x200 graphics API tuned for ILI9341.

Select the version in `main/urg32_config.h`, then build with ESP-IDF.
